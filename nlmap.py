...
from spot_utils.utils import pixel_to_vision_frame, pixel_to_vision_frame_depth_provided
...
category_name_string = "Book; Chair; Boxes; Door; Table; Picture; Something to sit on " 
